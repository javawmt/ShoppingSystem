...
<html>
	...
	<body>
		<%
			...
			try {
				session.setAttribute("phone_number", 2);
		...
		<!-- 信息区域 -->
		<img class="picture" src="image/phone2.png">
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-md-offset-5"><h2>HUAWEI P40 Pro+ 5G</h2></div>
			</div>
			<div class="row">
				<div class="col-md-7 col-md-offset-5"><h5>麒麟990&ensp;5G&ensp;SoC芯片, 纳米微晶陶瓷工艺, 5000万超感知徕卡五摄, 100倍双目变焦, 华为5G全网通旗舰手机</h5></div>
			</div>
			...
			<form action="DoPhone" method="post">
				<div class="form-group">
					...
					<div class="col-md-4 red"><h3>￥7988.00</h3></div>
				</div>
				<div class="form-group">
