...
/**
 * Servlet implementation class DoPhone5
 */
@WebServlet("/DoPhone5")
public class DoPhone5 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("Phone5.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
