...
/**
 * Servlet implementation class DoPhone4
 */
@WebServlet("/DoPhone4")
public class DoPhone4 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("Phone4.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
