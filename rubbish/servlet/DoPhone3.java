...
/**
 * Servlet implementation class DoPhone3
 */
@WebServlet("/DoPhone3")
public class DoPhone3 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String picture = "image/phone3.png";
			...
			request.getRequestDispatcher("Phone3.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
