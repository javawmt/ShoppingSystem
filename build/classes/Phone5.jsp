...
<html>
	<head>
		...
		<title>HUAWEI Mate 40 Pro+ 5G</title>
	...
	<body>
		<%
			...
			session.setAttribute("phone_number", 5);
			try {
		...
		<!-- 信息区域 -->
		<img class="picture" src="image/phone5.png">
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-md-offset-5"><h2>HUAWEI Mate 40 Pro+ 5G</h2></div>
			</div>
			...
			<form action="DoPhone" method="post">
				<div class="form-group">
					...
					<div class="col-md-4 red"><h3>￥8999.00</h3></div>
				</div>
				<div class="form-group">
