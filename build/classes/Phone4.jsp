...
<html>
	<head>
		...
		<title>HUAWEI Mate 30E Pro 5G</title>
	...
	<body>
		<%
			...
			session.setAttribute("phone_number", 4);
			try {
		...
		<!-- 信息区域 -->
		<img class="picture" src="image/phone4.png">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-5"><h2>HUAWEI Mate 30E Pro 5G</h2></div>
			</div>
			<div class="row">
				<div class="col-md-7 col-md-offset-5"><h5>麒麟990E&ensp;5G旗舰SoC芯片, 支持双模SA/NSA, 超感光徕卡电影影像, 超曲面OLED环幕屏, 40W有线与27W无线双超级快充, 3D面容支付与屏内指纹识别</h5></div>
			</div>
			...
			<form action="DoPhone" method="post">
				<div class="form-group">
					...
					<div class="col-md-4 red"><h3>￥5299.00</h3></div>
				</div>
				<div class="form-group">
